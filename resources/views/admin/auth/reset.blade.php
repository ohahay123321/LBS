...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .input-wrapper input[readonly] { opacity: 0.6; cursor: not-allowed; }
        .password-hint {
            color: #64748b;
            font-size: 12px;
            margin-top: 6px;
        ...
        <form method="POST" action="{{ route('admin.reset.submit') }}" autocomplete="off">
            ...
            <div class="input-group">
                ...
                <div class="input-wrapper">
                    ...
                    <input type="email" name="email" value="{{ request()->query('email') }}" readonly>
                </div>
            </div>
            ...
            <div class="input-group">
                ...
                <span class="password-hint">Must be 8+ characters with uppercase, lowercase, number, and symbol</span>
            </div>
