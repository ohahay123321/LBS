...
<body>
    <div class="receipt">
        ...
        <div class="receipt-body">
            <div class="section-title">Request #<?php echo e($request->id); ?></div>

            <div class="info-row">
                <span class="label">Status</span>
                <span class="value"><span class="status-badge <?php echo e(strtolower($request->status)); ?>"><?php echo e($request->status); ?></span></span>
            </div>
            ...
            <div class="info-row">
                ...
                <span class="value"><?php echo e($request->student_name); ?></span>
            </div>
            <div class="info-row">
                <span class="label">Student Number</span>
                <span class="value"><?php echo e($request->student_id_num); ?></span>
            </div>
            <div class="info-row">
                <span class="label">Email</span>
                <span class="value"><?php echo e($request->user->email ?? 'N/A'); ?></span>
            </div>
            ...
            <div class="info-row">
                ...
                <span class="value"><?php echo e($request->book->title ?? 'N/A'); ?></span>
            </div>
            <div class="info-row">
                <span class="label">Author</span>
                <span class="value"><?php echo e($request->book->author ?? 'N/A'); ?></span>
            </div>
            ...
            <div class="info-row">
                ...
                <span class="value"><?php echo e($request->req_date ? $request->req_date->format('M d, Y h:i A') : 'N/A'); ?></span>
            </div>
            <?php if($request->action_date && $request->admin): ?>
            <div class="info-row">
                <span class="label">Approved by</span>
                <span class="value"><?php echo e($request->admin->name); ?></span>
            </div>
            <?php endif; ?>
            <?php if($request->action_date): ?>
            <div class="info-row">
                <span class="label"><?php echo e($request->status == 'DENIED' ? 'Denied On' : 'Approved On'); ?></span>
                <span class="value"><?php echo e($request->action_date->format('M d, Y h:i A')); ?></span>
            </div>
            <?php endif; ?>
            <?php if($request->return_date): ?>
            <div class="info-row">
                <span class="label">Return By</span>
                <span class="value"><?php echo e($request->return_date->format('M d, Y h:i A')); ?></span>
            </div>
            <?php endif; ?>
            <?php if($request->status == 'RETURNED' && $request->fine > 0): ?>
            <div class="info-row">
                <span class="label">Fine</span>
                <span class="value" style="color: #ef4444;">$<?php echo e(number_format($request->fine, 2)); ?> <?php echo e($request->fine_paid ? '(Paid)' : '(Unpaid)'); ?></span>
            </div>
            <?php endif; ?>
        </div>

        <div class="receipt-footer">
            <a href="<?php echo e(route('student.dashboard')); ?>" class="btn-back">Back to Dashboard</a>
            <button onclick="window.print()" class="btn-print">Print Receipt</button>
        </div>
    </div>
</body>
</html>
<?php /**PATH C:\xampp\htdocs\LBS\resources\views/student/receipt.blade.php ENDPATH**/ ?>