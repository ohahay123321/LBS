...
<body>
    <div class="container">
        ...
        <div class="actions">
            <a href="<?php echo e(route('admin.login')); ?>" class="btn btn-primary">
            ...
            <a href="<?php echo e(route('admin.register')); ?>" class="btn btn-outline">
...
</html><?php /**PATH C:\xampp\htdocs\LBS\resources\views/admin/landing.blade.php ENDPATH**/ ?>