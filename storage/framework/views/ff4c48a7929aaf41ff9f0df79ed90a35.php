...
<body>
    <div class="auth-card">
        ...
        <form method="POST" action="<?php echo e(route('student.login.submit')); ?>" autocomplete="off">
            <?php echo csrf_field(); ?>
        ...
        <p class="auth-toggle">
            ...
            <a href="<?php echo e(route('student.register')); ?>">Create Account</a>
        </p>
...
<?php /**PATH C:\xampp\htdocs\LBS\resources\views/student/auth/login.blade.php ENDPATH**/ ?>