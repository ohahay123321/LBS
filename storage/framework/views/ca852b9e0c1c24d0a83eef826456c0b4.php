...
<body>
    <div class="container">
        <img src="<?php echo e(asset('imagess.png')); ?>" alt="Library System Logo" class="logo">
        ...
        <div class="portals">
            <a href="<?php echo e(route('admin.landing')); ?>" class="portal-card">
            ...
            <a href="<?php echo e(route('student.landing')); ?>" class="portal-card">
    ...
    <div class="footer">
        &copy; <?php echo e(date('Y')); ?> Library Management System. All rights reserved.
    </div>
</body>
</html>
<?php /**PATH C:\xampp\htdocs\LBS\resources\views/welcome.blade.php ENDPATH**/ ?>