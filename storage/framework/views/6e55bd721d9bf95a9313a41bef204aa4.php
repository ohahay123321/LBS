...
<body>
    <div class="container">
        ...
        <div class="actions">
            <a href="<?php echo e(route('student.login')); ?>" class="btn btn-primary">
            ...
            <a href="<?php echo e(route('student.register')); ?>" class="btn btn-outline">
...
</html><?php /**PATH C:\xampp\htdocs\LBS\resources\views/student/landing.blade.php ENDPATH**/ ?>