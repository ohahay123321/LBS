...
<body>
    <div class="auth-card">
        ...
        <form method="POST" action="<?php echo e(route('admin.register.submit')); ?>" autocomplete="off">
            <?php echo csrf_field(); ?>
            ...
            <div class="input-group">
                ...
                <div class="input-wrapper">
                    ...
                    <input type="email" name="email" placeholder="admin@example.com" required value="<?php echo e(old('email')); ?>">
                </div>
            </div>
...
<?php /**PATH C:\xampp\htdocs\LBS\resources\views/admin/auth/register.blade.php ENDPATH**/ ?>